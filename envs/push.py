...
class Push(gym.Env):
    def __init__(self, mode='default', observation_type='squares', seed=None):
        self.w = 10
        self.step_limit = 75
        self.n_boxes = 4
        self.n_obstacles = 0
        ...
        if self.observation_type == 'grid':
            ...
            self.observation_space = spaces.Box(0, 1, (self.w * self.render_scale, self.w * self.render_scale, 3))
        else:
