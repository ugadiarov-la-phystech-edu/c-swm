...
class Push(gym.Env):
    ...
    def __init__(self, n_boxes=5, n_static_boxes=0, n_goals=1, static_goals=True, width=5,
                 ...
                 seed=None, render_scale=10, n_interactions_per_step=2
                 ):
        if n_static_boxes > 0:
        ...
        self.n_interaction_per_step = n_interactions_per_step
    ...
    def _move(self, box_id, displacement, n_interactions):
        ...
        if not self._is_in_grid(box_new_pos, box_id):
            ...
            if self.n_interaction_per_step is not None and n_interactions >= self.n_interaction_per_step:
...
if __name__ == "__main__":
    ...
    env = Push(n_boxes=5, n_static_boxes=0, n_goals=1, static_goals=True, observation_type='shapes', border_walls=True,
               channels_first=False, width=7, embodied_agent=True, render_scale=10, return_state=False, n_interactions_per_step=2)
